...
export type ClientCapabilities = Partial<Record<FilterName, boolean>> & { [key: string]: any };
 ...
 */
export function detectCapabilitiesFromData(negotiationData: any): ClientCapabilities {
