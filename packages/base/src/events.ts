...
> extends Emittery<TEvents> {
  ...
  private async _emit<K extends keyof TEvents>(
    ...
    await super.emit(event, ...(args as [TEvents[K]]))
    return this
  }
   ...
   */
  async init(
    ...args: [TEvents['init']] extends [undefined]
      ? []
      : [data: TEvents['init']]
  ): Promise<this> {
   ...
   */
  async start(
    ...args: [TEvents['start']] extends [undefined]
      ? []
      : [data: TEvents['start']]
  ): Promise<this> {
   ...
   */
  async resume(
    ...args: [TEvents['resume']] extends [undefined]
      ? []
      : [data: TEvents['resume']]
  ): Promise<this> {
   ...
   */
  async suspend(
    ...args: [TEvents['suspend']] extends [undefined]
      ? []
      : [data: TEvents['suspend']]
  ): Promise<this> {
   ...
   */
  async stop(
    ...args: [TEvents['stop']] extends [undefined]
      ? []
      : [data: TEvents['stop']]
  ): Promise<this> {
   ...
   */
  async reset(
    ...args: [TEvents['reset']] extends [undefined]
      ? []
      : [data: TEvents['reset']]
  ): Promise<this> {
   ...
   */
  async destroy(
    ...args: [TEvents['destroy']] extends [undefined]
      ? []
      : [data: TEvents['destroy']]
  ): Promise<this> {
